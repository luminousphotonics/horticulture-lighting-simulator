...
SPECTRAL_RESPONSE_SCHEMA = "fspm_optics.fspm.plant_spectral_response.scaffold.v1"
...
PLANT_SPECTRAL_RESPONSE_SCHEMA = "fspm_optics.fspm.plant_spectral_response.v1"
...
def default_fixture_spectral_distribution(mode: str | None = None) -> SpectralPhotonDistribution:
    ...
    elif "competitor" in label or "conventional" in label:
        fractions = {
            "blue": 0.16,
            "green": 0.34,
            "red": 0.44,
