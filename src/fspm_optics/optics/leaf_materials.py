...
from fspm_optics.optics.profiles import LeafOpticalProfile
...
DEFAULT_FSPM_LEAF_RADIANCE_MATERIAL_MODE = LEAF_RADIANCE_MATERIAL_MODE_REX_SOURCE_WEIGHTED_TRANS
...
DEFAULT_FSPM_SPECTRAL_TRANSPORT_MODE = SPECTRAL_TRANSPORT_MODE_BANDED_5
