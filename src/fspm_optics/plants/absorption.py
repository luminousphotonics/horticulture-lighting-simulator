...
from fspm_optics.plants.models import LeafGeometry, PlantScene, Vector3
...
PHOTON_ABSORPTION_SCAFFOLD_SCHEMA = (
    "fspm_optics.fspm.plant_photon_absorption.scaffold.v1"
)
PHOTON_ABSORPTION_METRICS_SCHEMA = (
    "fspm_optics.fspm.plant_photon_absorption.metrics.v1"
)
