...
class PublicRadianceWebContractTests(unittest.TestCase):
    ...
    def test_dev_env_flag_shows_live_execution_modes(self) -> None:
        ...
        self.assertIn('id="rad-quality-field"', html)
        self.assertNotIn('id="rad-quality-field" hidden', html)
        self.assertIn('<span>Quality</span>', html)
        self.assertIn('<option value="standard" selected>Standard</option>', html)
        self.assertIn('<option value="quality">Quality</option>', html)
        self.assertIn('<option value="rigorous">Rigorous</option>', html)
        self.assertIn('id="rad-fspm-receiver-granularity"', html)
        self.assertIn('<option value="leaf_quadrature_4" selected>Quadrature 4</option>', html)
