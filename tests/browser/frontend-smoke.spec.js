...
test("about modal and GitHub actions are accessible", async ({ page }, testInfo) => {
  ...
  await expect(navGithub).toHaveAttribute("href", "https://github.com/luminousphotonics/rad_rebuild");
  ...
  await expect(modalGithub).toHaveAttribute("href", "https://github.com/luminousphotonics/rad_rebuild");
